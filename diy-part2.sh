...
cat > target/linux/rockchip/dts/rk3568/rk3566-panther-x2.dts << 'DTSEOF'
...
# 复制 Panther X2 WiFi 固件 (BCM43455/AP6236)
mkdir -p package/base-files/files/lib/firmware/brcm
# BCM43455 固件文件（通用 SDIO 版本）
# 这些文件将由 cypress-firmware-43455-sdio 包提供
# 但如果需要自定义固件，可以从以下位置获取：
# https://github.com/openwrt/firmware_qca-wireless
# 或者使用 cypress-firmware 包
